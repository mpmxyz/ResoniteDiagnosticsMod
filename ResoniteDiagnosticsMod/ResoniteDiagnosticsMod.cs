...
public class ResoniteDiagnosticsMod : ResoniteMod {
	internal const string VERSION_CONSTANT = "1.0.0";
	public override string Name => "ResoniteDiagnosticsMod";
	public override string Author => "mpmxyz";
	public override string Version => VERSION_CONSTANT;
	public override string Link => "https://github.com/mpmxyz/ResoniteDiagnosticsMod/";
	...
	public override void OnEngineInit() {
		...
		var harmony = new Harmony("mpmxyz.ResoniteDiagnosticsMod");
		harmony.PatchAll();
